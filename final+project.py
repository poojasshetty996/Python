...
w1.title('My app')
w1.geometry('700x700')
ptitle=Label(w1,text='''Employee Database Management System''',font=('ariel',18,'bold'))
...
b1=Button(w1,text='Search',command=search,font=('ariel',14))
b2=Button(w1,text='Add',command=add,font=('ariel',14))
b3=Button(w1,text='Update',command=update,font=('ariel',14))
b4=Button(w1,text='Delete',command=delete,font=('ariel',14))
b5=Button(w1,text='Clear',command=clear,font=('ariel',14))
